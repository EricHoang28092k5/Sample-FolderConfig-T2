...
<?php if (isset($_GET['useroremailtaken'])): ?>
<script>
  // Gọi modal hiển thị lỗi khi người dùng đăng ký trùng email/tên đăng nhập
...
<script>
// === HÀM HIỂN THỊ MODAL LỖI ĐĂNG KÝ ===
  ...
  modalContainer.innerHTML = `
    <div class="modal" id="modal-demo">
      ...
      <div class="modal_body">
        <p>Tài khoản đã được đã được đăng ký. Hãy kiểm tra lại</p>
        <a href="signUp.php">Thử lại</a>
      </div>
    </div>
  `;
